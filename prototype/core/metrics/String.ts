/** Verbatim port of legacy `@cocoon/plugin-distance/metrics/String.ts`.
 *  string-similarity → `./numeric.ts`. */
import type { Metric, MetricResult } from './index.ts';
import { compareTwoStrings } from './numeric.ts';
...
export interface Config {
  ...
  /**
   * If true, the first character must be identical. This speeds up the
   * matching significantly and handles many real-world use-cases better
   * ("7 Wonders" vs "Wonders").
   */
