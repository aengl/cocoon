...
export interface CocoonNodeContext<PortDataType = PortData, ViewDataType = any, ViewStateType = any> {
    debug: (...args: any[]) => void;
...
export interface CocoonNode<PortDataType = PortData, ViewDataType = any, ViewStateType = any> extends CocoonNodePorts {
    category?: string;
    defaultPort?: PortInfo;
    description?: string;
    persist?: boolean;
    supportedViewStates?: string[];
    process(context: CocoonNodeContext<PortDataType, ViewDataType, ViewStateType>): Promise<string | void>;
    receive?(context: CocoonNodeContext<PortDataType, ViewDataType, ViewStateType>, data: any): void;
}
...
export interface GraphNode<PortDataType = PortData, ViewDataType = any, ViewStateType = any> {
...
export interface CocoonDefinitions {
    description?: string;
    nodes: {
        [nodeId: string]: CocoonNodeDefinition;
    };
}
...
export interface CocoonViewContext<ViewDataType = any, ViewStateType = any, ViewQueryType = any, ViewQueryResponseType = any> {
    debug: (...args: any[]) => void;
    ...
    query: (query: ViewQueryType, callback: (args: {
        data?: any;
    }) => any) => ViewQueryResponseType;
    send: (data: any) => void;
...
export interface CocoonViewProps<ViewDataType = any, ViewStateType = any, ViewQueryType = any, ViewQueryResponseType = any> {
    context: CocoonViewContext<ViewDataType, ViewStateType, ViewQueryType, ViewQueryResponseType>;
}
export interface CocoonView<ViewDataType = any, ViewStateType = any, ViewQueryType = any, ViewQueryResponseType = any> {
    component?: string;
    defaultPort?: PortInfo;
    serialiseViewData(context: CocoonNodeContext<any, ViewDataType, ViewStateType>, data: any, state: ViewStateType): Promise<ViewDataType | null>;
    respondToQuery?(context: CocoonNodeContext<any, ViewDataType, ViewStateType>, data: any, query: ViewQueryType): ViewQueryResponseType;
}
export declare type CocoonViewComponent = (props: CocoonViewProps) => JSX.Element;
